 ...
 */
export const getSecondCard = ([card1, card2]) => {
  return card2;
}
 ...
 */
export const swapTwoCards = ([card1, card2]) => {
  return [card2,card1];
}
 ...
 */
export const shiftThreeCardsAround = ([card1,card2,card3]) => {
 ...
 */
export const pickNamedPile = ({chosen, disregarded}) => {
  return chosen;
}
